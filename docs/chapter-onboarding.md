...
All new chapter leaders are invited to participate in a structured onboarding session where we'll cover:
...
These sessions are scheduled regularly. Details are shared in the Discord #chapter-leads channel and pinned in key announcements. Attending is highly encouraged for a smooth launch.
